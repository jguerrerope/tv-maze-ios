...
extension UIView {
    ...
    @discardableResult
    public func anchorCenterToView(_ view: UIView, constantX: CGFloat = 0, constantY: CGFloat = 0, active: Bool = true) -> [NSLayoutConstraint] {
        var anchors = [NSLayoutConstraint]()
    ...
    @discardableResult
    public func anchorCenterToView(_ view: UILayoutGuide, constantX: CGFloat = 0, constantY: CGFloat = 0, active: Bool = true) -> [NSLayoutConstraint] {
        var anchors = [NSLayoutConstraint]()
